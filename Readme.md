...
2. Манифест развертывания кластера Mysql расположен в [файле](terraform/main.tf)
   ...
   ```
    ...
    ```
3. Создание кластера реализовано в виде отдельного модуля, расположенного в [папке](terraform/modules/mysql)
...
В итоге был создан кластер Mysql:
...
1. Манифест развертывания кластера kubernetes расположен в [файле](terraform/main.tf)
   ...
   ```
2. Создание кластера реализовано в виде отдельного модуля, расположенного в [папке](terraform/modules/k8s_regional)
